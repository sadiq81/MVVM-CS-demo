...
final class UserService: UserServiceType, @unchecked Sendable {
    ...
    func removeVerification() async throws {
        _ = try await self.networkService.removeVerification()
        try await self.refreshProfile()
    }
...
struct Country: Hashable {
    ...
    nonisolated(unsafe) static var prefixes: [String : String] = [
