...
extension UserEndPoint: Endpoint {
    ...
    var method: RequestType {
        switch self {
            ...
            case .removeVerification: return .post
        }
    }
    ...
    var path: String {
        switch self {
            ...
            case .removeVerification: return "/user/remove-verification"
        }
    }
...
extension AsyncNetworkServiceType {
    ...
    @discardableResult
    func removeVerification() async throws -> UserResponse {
        return try await self.send(endpoint: UserEndPoint.removeVerification)
    }
