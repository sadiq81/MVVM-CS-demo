...
extension UIImageView {
    ...
    func configurePinLoadingIndicator() {
        self.image = UIImage(systemName: Images.System.loading)
    ...
    func showPinSuccessAnimation() async throws {
        ...
        self.setSymbolImage(UIImage(systemName: Images.System.checkmarkCircleFill)!, contentTransition: .replace.offUp)
