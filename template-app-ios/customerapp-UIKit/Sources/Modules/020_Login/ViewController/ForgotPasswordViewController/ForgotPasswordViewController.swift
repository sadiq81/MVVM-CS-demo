...
final class ForgotPasswordViewController: UIViewController {
    ...
    @Injected(\.forgotPasswordViewModel)
    private var viewModel: any ForgotPasswordViewModelType
...
#if DEBUG
#Preview("ForgotPasswordViewController") {
    Container.shared.forgotPasswordViewModel.register { PreviewForgotPasswordViewModel() }
    Container.shared.loggingService.register { PreviewLoggingService() }

    let viewController = AppStoryboard.viewController(class: ForgotPasswordViewController.self)
