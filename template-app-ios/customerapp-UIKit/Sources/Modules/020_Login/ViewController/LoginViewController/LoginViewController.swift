...
final class LoginViewController: UIViewController {
    ...
    @Injected(\.loginViewModel)
    private var viewModel: any LoginViewModelType
    ...
    private func configureView() {
        ...
        self.emailContainerView.backgroundColor = Colors.Background.neutralSubtle.color
        self.emailContainerView.layer.cornerRadius = Constants.Rounding.small
        self.passwordContainerView.backgroundColor = Colors.Background.neutralSubtle.color
        self.passwordContainerView.layer.cornerRadius = Constants.Rounding.small
        ...
        self.eyeButton.tintColor = Colors.Foreground.default.color
        ...
        self.signupButton.configure(style: .link, text: Strings.Login.Button.Signup.title)
    }
    ...
    @IBAction func signupTapped() {
        try? self.coordinator.transition(to: LoginTransition.signup)
    }
...
#Preview("LoginViewController") {
    Container.shared.loginViewModel.register { PreviewLoginViewModel() }
    Container.shared.loggingService.register { PreviewLoggingService() }

    let viewController = AppStoryboard.viewController(class: LoginViewController.self)
