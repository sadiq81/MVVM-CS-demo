...
final class PinEnrollViewController: BackgroundDimmingViewController {
...
#if DEBUG
#Preview("PinEnrollViewController") {
    Container.shared.pinViewModelType.register { PreviewPinViewModel() }

    let viewController = AppStoryboard.viewController(class: PinEnrollViewController.self)
