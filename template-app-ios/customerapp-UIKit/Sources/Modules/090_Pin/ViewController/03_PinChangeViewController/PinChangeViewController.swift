...
final class PinChangeViewController: BackgroundDimmingViewController {
...
#if DEBUG
#Preview("PinChangeViewController") {
    Container.shared.pinViewModelType.register { PreviewPinViewModel() }

    let viewController = AppStoryboard.viewController(class: PinChangeViewController.self)
