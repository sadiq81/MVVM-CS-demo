...
protocol PinViewModelType: Sendable {
...
final class PinViewModel: PinViewModelType, @unchecked Sendable {
    ...
    private var storageService: any SecureStorageServiceType
...
final class PreviewPinViewModel: PinViewModelType, @unchecked Sendable {
