...
final class ProductSearchViewModel: @preconcurrency ProductSearchViewModelType {
    ...
    private var filterServiceType: any FiltersServiceType
...
final class PreviewProductSearchViewModel: ProductSearchViewModelType, @unchecked Sendable {
    ...
    var searchResultsPublisher: AnyPublisher<ProductSearchResult?, Never> {
        return Just(ProductSearchResult.mockData).eraseToAnyPublisher()
    }
