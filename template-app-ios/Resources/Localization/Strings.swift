...
internal enum Strings {
  internal enum Alert {
    internal enum BirthdayRemoveValidation {
      /// Er du sikker på, at du vil fjerne din aldersbekræftelse?
      internal static let message = Strings.tr("Localizable", "alert.birthdayRemoveValidation.message", fallback: "Er du sikker på, at du vil fjerne din aldersbekræftelse?")
      /// Fjern bekræftelse
      internal static let title = Strings.tr("Localizable", "alert.birthdayRemoveValidation.title", fallback: "Fjern bekræftelse")
    }
    internal enum BirthdayValidation {
      /// Din fødselsdato er nu bekræftet.
      internal static let message = Strings.tr("Localizable", "alert.birthdayValidation.message", fallback: "Din fødselsdato er nu bekræftet.")
      /// Bekræft alder
      internal static let title = Strings.tr("Localizable", "alert.birthdayValidation.title", fallback: "Bekræft alder")
    }
    ...
    internal enum PasswordReset {
      /// Vi har sendt en e-mail med instruktioner til at nulstille din adgangskode.
      internal static let message = Strings.tr("Localizable", "alert.passwordReset.message", fallback: "Vi har sendt en e-mail med instruktioner til at nulstille din adgangskode.")
      /// E-mail sendt
      internal static let title = Strings.tr("Localizable", "alert.passwordReset.title", fallback: "E-mail sendt")
    }
    internal enum Pin {
  ...
  internal enum Login {
    ...
    internal enum Button {
      ...
      internal enum Signup {
        /// Opret konto
        internal static let title = Strings.tr("Localizable", "login.button.signup.title", fallback: "Opret konto")
      }
    }
    internal enum Textfield {
  ...
  internal enum Profile {
    internal enum Address {
      ...
      internal static let emptyState = Strings.tr("Localizable", "profile.address.emptyState", fallback: "Ingen adresser fundet")
      /// Vælg adresse
      internal static let title = Strings.tr("Localizable", "profile.address.title", fallback: "Vælg adresse")
  ...
  internal enum Signup {
    /// Udfyld dine oplysninger for at oprette en konto.
    internal static let body = Strings.tr("Localizable", "signup.body", fallback: "Udfyld dine oplysninger for at oprette en konto.")
    /// OPRET KONTO
    internal static let title = Strings.tr("Localizable", "signup.title", fallback: "OPRET KONTO")
    internal enum Button {
      internal enum Signup {
        /// OPRET KONTO
        internal static let title = Strings.tr("Localizable", "signup.button.signup.title", fallback: "OPRET KONTO")
      }
    }
    internal enum Textfield {
      internal enum Confirmpassword {
        /// Gentag adgangskode
        internal static let placeholder = Strings.tr("Localizable", "signup.textfield.confirmpassword.placeholder", fallback: "Gentag adgangskode")
      }
      internal enum Email {
        /// Email
        internal static let placeholder = Strings.tr("Localizable", "signup.textfield.email.placeholder", fallback: "Email")
      }
      internal enum Fullname {
        /// Fulde navn
        internal static let placeholder = Strings.tr("Localizable", "signup.textfield.fullname.placeholder", fallback: "Fulde navn")
      }
      internal enum Password {
        /// Adgangskode
        internal static let placeholder = Strings.tr("Localizable", "signup.textfield.password.placeholder", fallback: "Adgangskode")
      }
    }
  }
