...
struct FilterSearchView: View {
    ...
    @ObservedObject
    private var viewModel: FilterSearchViewModel

    init(filterType: ProductFilterType, viewModel: FilterSearchViewModel) {
        self.viewModel = viewModel
        self.viewModel.filterType = filterType
    }
        ...
        NavigationStack {
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    Button(action: { self.viewModel.isFinished = true }) {
...
#Preview("FilterSearchView") {
    ...
    return FilterSearchView(filterType: .brand, viewModel: viewModel)
}
#endif
