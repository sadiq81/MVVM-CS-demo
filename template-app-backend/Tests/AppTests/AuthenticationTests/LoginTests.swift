...
////        let loginRequest = LoginRequest(email: "test@test.com", password: "password", installationId: UUID())
////        
...
////        let loginRequest = LoginRequest(email: "none@login.com", password: "123", installationId: UUID())
////        
////        try app.test(.POST, loginPath, beforeRequest: { req in
////            try req.content.encode(loginRequest)
////        }, afterResponse: { res in
...
////        try app.repositories.users.create(user).wait()
////        
////        let loginRequest = LoginRequest(email: "test@test.com", password: "wrongpassword", installationId: UUID())
////        
////        try app.test(.POST, loginPath, beforeRequest: { req in
////            try req.content.encode(loginRequest)
////        }, afterResponse: { res in
