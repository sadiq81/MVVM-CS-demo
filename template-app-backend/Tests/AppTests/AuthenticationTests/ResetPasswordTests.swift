...
////        
////        let resetPasswordRequest = ResetPasswordRequest(email: "test@test.com", installationId: UUID())
...
////        let resetPasswordRequest = ResetPasswordRequest(email: "none@test.com", installationId: UUID())
////        try app.test(.POST, "api/auth/reset-password", content: resetPasswordRequest, afterResponse: { res in
////            XCTAssertEqual(res.status, .noContent)
