...
enum AuthenticationError: AppError {
    ...
    case installtionNotFound
    case birthdateIsVerified
}
...
extension AuthenticationError: AbortError {
    ...
    var reason: String {
        ...
        case .installtionNotFound:
            return "Installtion Not Found"
            case .birthdateIsVerified:
                return "Birthdate is verified, remove verification first"
    ...
    var identifier: String {
        ...
        case .installtionNotFound:
            return "installtion_not_found"
        case .birthdateIsVerified:
            return "birthdate_is_verified"
        }
    }
